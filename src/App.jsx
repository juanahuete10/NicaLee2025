...
import VerPerfilEstudiante from "./components/Formularios/VerPerfilEstudiante";
import EditarPerfilEstudiante from "./components/Formularios/EditarPerfilEstudiante";
        ...
        <div className="App">
          ...
          <main>
            <Routes>
              ...
              <Route path="/ver-perfil-estudiantes" element={<VerPerfilEstudiante />} />
              <Route path="/editar-perfil-estudiante" element={<EditarPerfilEstudiante />} />
            </Routes>
          </main>
        </div>
      </Router>
